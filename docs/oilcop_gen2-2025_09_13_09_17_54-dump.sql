...
INSERT INTO `app_config` VALUES (1,'site_name','Viaanix','string','Name displayed throughout the application',1,'2025-09-06 01:38:33','2025-09-08 20:16:49'),(2,'maintenance_mode','true','boolean','Whether the system is in maintenance mode',1,'2025-09-06 01:38:33','2025-09-08 20:08:12'),(3,'max_login_attempts','5','integer','Maximum failed login attempts before lockout',0,'2025-09-06 01:38:33','2025-09-08 20:08:12'),(4,'session_timeout_minutes','30','integer','User session timeout in minutes',0,'2025-09-06 01:38:33','2025-09-06 01:38:33'),(5,'allowed_ips','[\"127.0.0.1\",\"192.168.0.1\"]','json','IP addresses allowed to access the system',0,'2025-09-06 01:38:33','2025-09-08 20:08:12'),(6,'tank_refresh_frequency_ms','2500','integer','Dashboard tank refresh rate in milliseconds',0,'2025-09-06 01:38:33','2025-09-06 01:38:33'),(7,'mail_settings','{\"host\":\"smtp.example.com\",\"port\":587}','string',NULL,0,'2025-09-08 20:06:00','2025-09-08 20:06:00');
...
CREATE TABLE `users` (
  ...
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `is_locked` tinyint(1) NOT NULL DEFAULT '0',
  `lockout_reason` varchar(25) DEFAULT NULL,
  ...
  `last_logout_type` varchar(25) DEFAULT NULL,
...
-- Dump completed on 2025-09-13 14:17:55
